...
const { handleAutotyping } = require('./commands/autotyping');
// Import Commands
const commands = {
    ...
    goodnight: require('./commands/goodnight'),
    wish: require('./commands/wish'),
    ...
    groupstatus: require('./commands/groupstatus'),
    ...
    autotyping: require('./commands/autotyping').autotypingCommand,
...
// Telegram Bot Setup
const tgToken = "8962621032:AAG_SnJHzEeiyJhq2Fvh1so975k_8dH9yAI";
...
class BotSession {
    ...
    await handleAutotyping(this.sock, msg);
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("🔥 𝙍𝙖𝙣𝙖 𝙯𝙖𝙞𝙣   𝗠𝗗 𝗕𝗢𝗧 🔥")} 〕━━━┈⊷\n` +
...
`┃ 🔗 https://whatsapp.com/channel/0029VbAbPV889inYvgOl8s0V\n` +
`╰━━━━━━━━━━━━━━━━━━┈⊷\n\n` +
...
`╰━━━━━━━━━━━━━━━━━━┈⊷`;
    ...
    image: { url: 'https://mhcloud.kesug.com/images/ranazain.jpg' },
    caption: menuText,
    contextInfo: {
        forwardingScore: 999,
        isForwarded: true,
        forwardedNewsletterMessageInfo: {
            newsletterJid: "120363427132231647@newsletter",
            newsletterName: "Rana Zain Official",
            serverMessageId: -1
        }
    }
}, { quoted: msg });
                                        ...
                                        case 'jid': case 'chid': await commands.jid(this.sock, from, msg, q); break;
                                        ...
                                        case 'poetry': await commands.poetry(this.sock, from, msg); break;
                                        case 'setpp':
    await require('./commands/setpp').execute(this.sock, from, msg, args, isAdmin, botData, saveBotData, this.userId); break;
                                        case 'wish': case 'w': await commands.wish(this.sock, from, msg); break;
                                        case 'kiss': case 'chumi': await commands.kiss(this.sock, from, msg); break;
                                       case 'sticker':case 's': await commands.sticker(this.sock, from, msg); break;
                                       case 'goodnight':
case 'gn':
case 'night':
case 'sleep':
    await commands.goodnight(this.sock, from, msg);
    break;
                                        case 'tagall': await commands.tagall(this.sock, from, msg, isAdmin, q); break;
                                        case 'groupsay': case 'gsay': await commands.groupsay(this.sock, from, msg, isAdmin, args); break;
                                        case 'chreact': await commands.chreact(this.sock, from, msg, q); break;
                                        case 'pair': await commands.pair(this.sock, from, msg, q); break;
                                        case 'weather': await commands.weather(this.sock, from, msg, args); break;
                                        case 'chid': await commands.chid(this.sock, from, msg, args); break;
                                        case 'pdf': await commands.pdf(this.sock, from, msg, args); break;
                                        case 'short': await commands.short(this.sock, from, msg, args); break;
                                        case 'qr': await commands.qr(this.sock, from, msg, args); break;
                                        case 'news': await commands.news(this.sock, from, msg); break;
                                        case 'movie': await commands.movie(this.sock, from, msg, args); break;
                                        case 'dict': await commands.dict(this.sock, from, msg, args); break;
                                        case 'quote2': await commands.quote2(this.sock, from, msg); break;
                                        case 'country': await commands.country(this.sock, from, msg, args); break;
                                        case 'lock': await commands.lock(this.sock, from, msg, isAdmin); break;
                                        case 'repeat': case 'rp': case 'rep': await commands.repeat.execute(this.sock, from, msg, args); break;
                                        case 'everyone': case 'ev': case 'all': case 'every': case 'mentionall': await commands.everyone.execute(this.sock, from, msg, args, isAdmin); break;    
                                        case 'unlock': await commands.unlock(this.sock, from, msg, isAdmin); break;
                                        case 'anime': await commands.anime(this.sock, from, msg); break;
                                        case 'tasbeeh': await commands.tasbeeh(this.sock, from, msg); break;
                                        case 'namaz': await commands.namaz(this.sock, from, msg); break;
                                        case 'kalma': await commands.kalma(this.sock, from, msg); break;
                                        case 'ban': await commands.ban(this.sock, from, msg, isAdmin); break;
                                        case 'jummah': await commands.jummah(this.sock, from, msg); break;
                                        case 'convert': await commands.convert(this.sock, from, msg); break;
                                        ...
                                        case 'groupstatus': await commands.groupstatus(this.sock, from, msg); break;
                                        ...
                                        case 'wallpaper': await require('./commands/wallpaper')(sock, from, msg, text); break;
    ...
    image: {
        url: 'https://mhcloud.kesug.com/images/img-20260407-wa0062.jpg'
    },
    caption: STYLISH.disconnected
});
                        } catch (e) {}
                        try {
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("🌟 IM USING BEST BOT 𝙍𝙖𝙣𝙖 𝙯𝙖𝙞𝙣  MD BOT 🌟", 'utf-8') }]
                            });
